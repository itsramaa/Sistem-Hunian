...
## How to Access Skills in Antigravity

Use the `Read` tool on skill files located at `~/.gemini/antigravity-ide/skills/superpowers/skills/{skill-name}/SKILL.md`.
...
**To load a skill:** `Read ~/.gemini/antigravity-ide/skills/superpowers/skills/{skill-name}/SKILL.md`

## Tool Mapping for Antigravity

When skills reference tools, use these Antigravity equivalents:

- `Skill` tool → Use `Read` tool on `~/.gemini/antigravity-ide/skills/superpowers/skills/{skill-name}/SKILL.md`
