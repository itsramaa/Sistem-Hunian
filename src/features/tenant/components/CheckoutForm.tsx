...
interface CheckoutFormProps {
  ...
  tenantName: string;
  roomNumber: string;
  onSubmit: (tanggal_keluar: string) => Promise<void>;
  isLoading: boolean;
}

export function CheckoutForm({ open, onOpenChange, tenantName, roomNumber, onSubmit, isLoading }: CheckoutFormProps) {
      ...
      <DialogContent className="sm:max-w-md rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          <div className="flex items-start gap-3 p-3 rounded-xl bg-warning/10 border border-warning/20 text-sm">
            ...
            <span>
              Penghuni akan di-checkout dan kamar akan kembali menjadi <strong>tersedia</strong>.
              Histori hunian tetap tersimpan.
            </span>
          </div>
          ...
          <DialogFooter className="pt-2">
            ...
            <Button type="submit" variant="destructive" disabled={isLoading || !tanggal} className="gap-2 rounded-xl">
