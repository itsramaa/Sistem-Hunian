  ...
  return (
    <div className={`space-y-3 ${className}`}>
      <div className="flex flex-col md:flex-row gap-3">
        ...
        {/* View Toggle */}
        <div className="flex gap-1 border rounded-lg p-1 bg-muted/20 shrink-0">
          <Button
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {typeFilter !== 'all' && (
            <Badge variant="secondary" className="text-xs gap-1 pr-1">
              ...
              <button onClick={() => onTypeFilterChange('all')} className="ml-1 hover:bg-muted rounded-full p-0.5">
                <X className="h-3 w-3" />
              </button>
            </Badge>
          )}
          {statusFilter !== 'all' && (
            <Badge variant="secondary" className="text-xs gap-1 pr-1">
              ...
              <button onClick={() => onStatusFilterChange('all')} className="ml-1 hover:bg-muted rounded-full p-0.5">
                <X className="h-3 w-3" />
              </button>
            </Badge>
          )}
          {searchTerm && (
            <Badge variant="secondary" className="text-xs gap-1 pr-1">
              Search: "{searchTerm}"
              <button onClick={() => onSearchChange('')} className="ml-1 hover:bg-muted rounded-full p-0.5">
                <X className="h-3 w-3" />
              </button>
            </Badge>
          )}
          <Button variant="ghost" size="sm" className="h-6 text-xs px-2" onClick={onResetFilters}>
