...
// Redirect path per role after login
...
export function ProtectedRoute({ children, allowedRoles }: ProtectedRouteProps) {
  ...
  // Only show skeleton on initial cold load (no user yet)
  // When navigating between pages while already authenticated,
  // skip skeleton to prevent sidebar from disappearing
  if (isLoading && !user) {
