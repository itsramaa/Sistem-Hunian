          ...
          <CardContent>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                Simpan kode pemulihan Anda di lokasi yang aman
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
                Jangan pernah membagikan kode QR atau kunci rahasia autentikator Anda
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
                Jika kehilangan akses ke autentikator, gunakan kode pemulihan untuk masuk
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
