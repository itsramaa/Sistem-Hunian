    ...
    <div className="glass-filter-bar">
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <Input placeholder="Cari nama penyewa, properti, atau unit..." value={searchTerm} onChange={(e) => onSearchChange(e.target.value)} className="pl-9 rounded-xl bg-background/60 border-border/50" />
        </div>
        <Select value={statusFilter} onValueChange={onStatusFilterChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="notice">Masa Notice</SelectItem>
