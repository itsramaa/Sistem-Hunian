...
export default function PaymentsPage() {
  ...
  // File select with preview — per SRS §4.6 "Preview file sebelum submit"
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Upload bukti — dengan preview per SRS §4.6 */}
      <Dialog open={!!uploadTarget} onOpenChange={v => !v && closeUploadModal()}>
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <div className="space-y-4 py-2">
            ...
            {/* Preview — per SRS §4.6 "Preview file sebelum submit" */}
            {uploadFile && (
