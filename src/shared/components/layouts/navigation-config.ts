...
export const navigationConfig: Record<UserRole, RoleConfig> = {
  ...
  merchant: {
    ...
    mainNav: [
      ...
      },
      {
        ...
        items: [
          ...
          { path: "/merchant/maintenance", icon: Wrench, label: "Maintenance", activePatterns: ["/merchant/preventive-maintenance"] },
          { path: "/merchant/guardians", icon: UserCheck, label: "Penjaga (Tim On-Site)" },
        ],
      },
      {
        label: "Penyewa & Kontrak",
        items: [
          { path: "/merchant/tenants", icon: Users, label: "Penyewa", activePatterns: ["/merchant/move-outs", "/merchant/tenant-analytics", "/merchant/tenant-screening"] },
      ...
      },
      {
        label: "Keuangan",
        items: [
          { path: "/merchant/financial-control", icon: Shield, label: "Kontrol Keuangan" },
    ...
    bottomNav: [
      ...
      { path: "/merchant/invoices", icon: FileText, label: "Tagihan" },
      { path: "/merchant/alerts", icon: AlertTriangle, label: "Notifikasi" },
      { path: "/merchant/profile", icon: User, label: "Profil" },
    ],
    hasBottomNav: true,
    hasFloatingAI: true,
