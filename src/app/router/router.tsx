...
const OperatorCheckouts = lazy(() => import("@/features/tenant/pages/Tenants"));
...
const OperatorUsers = lazy(() => import("@/features/users/pages/UsersPage"));
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* Kelola Pengguna — Operator only */}
        <Route path="users" element={<ProtectedRoute allowedRoles={['operator']}><DS><OperatorUsers /></DS></ProtectedRoute>} />
        {/* Misc */}
