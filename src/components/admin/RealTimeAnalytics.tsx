...
import { BarChart, Bar, LineChart, Line, XAxis, YAxis, PieChart, Pie, Cell, AreaChart, Area } from "recharts";
import { Activity, Eye, CreditCard, MousePointer, MessageSquare, TrendingUp, Clock, Users } from "lucide-react";
import { format, subDays, startOfDay, endOfDay, parseISO, subHours } from "date-fns";
