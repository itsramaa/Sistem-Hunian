...
import { VENDOR_PLATFORM_FEE_PERCENT } from '@/lib/constants/platformFees';
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Platform Fee ({VENDOR_PLATFORM_FEE_PERCENT}%)</p>
          ...
          <CardContent>
            ...
            <div className="text-center mt-4">
              <p className="text-sm text-muted-foreground">
                You keep <span className="font-semibold text-success">{100 - VENDOR_PLATFORM_FEE_PERCENT}%</span> of every transaction
              </p>
            </div>
          </CardContent>
        </Card>
