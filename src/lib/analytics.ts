...
const PII_FIELDS = ['email', 'phone', 'password', 'ssn', 'credit_card', 'ktp', 'nik', 'bank_account'];
...
const sanitizeEventData = (data: Record<string, any>): Record<string, string | number | boolean | null> => {
