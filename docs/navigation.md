...
│       ├── Page: pages/merchant/OcrTutorial.tsx
│       └── Feature Components/
│           └── (None - Uses Shared UI only)
│
├── Secondary Navigation/
│   ├── Support/
│   │   ├── Path: /merchant/support
│   │   ├── Page: pages/merchant/Support.tsx
│   │   └── Feature Components/
│   │       └── (None - Uses Shared UI only)
│   │
│   └── Feedback/
│       └── Type: External Link (mailto:support@sihuni.com)
│
└── User Menu/
    ├── Profile/
    ...
    │   └── Feature Components/
    │       └── BankAccountManager.tsx (features/payments/components/)
    │
    ├── Settings/
    │   ├── Path: /merchant/settings
    │   ├── Page: pages/merchant/Settings.tsx
    │   └── Feature Components/
    │       ├── MerchantNotificationSettings.tsx (features/notifications/components/)
    │       ├── BankAccountManager.tsx (features/payments/components/)
    │       └── DisbursementScheduleSettings.tsx (features/payments/components/)
    │
    └── Billing/
        ├── Path: /merchant/billing
        ├── Page: pages/merchant/Billing.tsx
        └── Feature Components/
            ├── BillingDashboard.tsx (features/billing/components/)
            ├── DisbursementScheduleSettings.tsx (features/payments/components/)
            └── SuspensionWarningBanner.tsx (features/users/components/)
