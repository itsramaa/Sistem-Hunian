...
| ID | Severity | Issue | Location | Recommendation |
|----|----------|-------|----------|----------------|
| PAY-V01 | High | Reference field has no validation/sanitization | Mark Paid dialog | Add input validation |
| PAY-V02 | High | Payment method selection not validated | Mark Paid dialog | Ensure valid payment method selected |
...
| PAY-S02 | High | No verification that merchant owns payment | markPaidMutation | Add ownership check |
...
| ID | Severity | Issue | Location | Recommendation |
|----|----------|-------|----------|----------------|
| PAY-E01 | High | Bulk reminder errors show generic message | sendBulkReminderMutation | Show specific failure count |
