...
| ID | Severity | Issue | Location | Recommendation | Status |
|----|----------|-------|----------|----------------|--------|
| MVO-V01 | High | No validation that inspection date is before move-out date | ScheduleInspectionDialog | Add date range validation | ✅ Fixed |
...
| MVO-V03 | Medium | Deduction details can exceed deposit amount | MoveOutInspectionForm | Validate total deductions <= deposit | ✅ Fixed |
...
| MVO-C02 | Critical | Deposit refund not automatically created after inspection | MoveOutInspectionForm | Auto-create deposit_refund record | ✅ Fixed |
...
8. ✅ Add inspection date validation (before move-out)
9. ✅ Validate deductions cannot exceed deposit
